    ...
    return () => {
      ...
      return (
        <div class={classNames["form-panel"]}>
          ...
          >
            <DArrowRight class={[classNames["arrow"], showFromPanel ? classNames["expand"] : classNames["fold"]]} />
          </div>
          <div class={[classNames["form-panel-content"], showFromPanel ? classNames["expand"] : classNames["fold"]]}>
            <el-form model="form" label-width="auto" style="max-width: 600px">

              <el-form-item label="作业类型">
                <el-select v-model={state.formData.region} placeholder="请选择作业类型" class="custom-select" >
              ...
              <el-form-item>
                <el-button type="primary" onClick={onSubmit}>Create</el-button>
